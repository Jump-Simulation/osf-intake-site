  ...
  chapterObjects: [
        ...
        // Introduction Screen 1
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                "It may not be your fault that you have very high cholesterol...",
              textType: "h4",
              textAlignment: "left",
            },
        ...
        // Introduction Screen 4
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'People with FH who are diagnosed and treated <span style="color: var(--color-accent-tertiary-bold-800-default);">live 20-30 years longer.</span>',
              textType: "h2",
              textAlignment: "left",
            },

            {
              ...
              colorOverrideDefault:
                "linear-gradient(180deg, rgba(0, 0, 0, 0.02) 0%, rgba(0, 0, 0, 0.09) 100%)",
              colorOverrideHover:
                "linear-gradient(180deg, rgba(0, 0, 0, 0.02) 14.9%, rgba(0, 0, 0, 0.15) 100%)",
              colorOverrideActive:
                "linear-gradient(180deg, rgba(0, 0, 0, 0.12) 14.9%, rgba(0, 0, 0, 0.15) 100%)",
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  buttonStyle: "primary",
                  colorOverrideDefault:
                    "radial-gradient(40.23% 100% at 50.18% 0%, var(--color-accent-tertiary-700-default, #487D02) 0%, var(--color-accent-tertiary-bold-800-default, #3C6A00) 100%)",
                  colorOverrideHover:
                    "radial-gradient(40.41% 100% at 50.18% 0%, var(--color-accent-tertiary-600-default, #579605) 0%, var(--color-accent-tertiary-bold-800-default, #3C6A00) 100%)",
                  colorOverrideActive:
                    "radial-gradient(116.84% 49.82% at 50.18% 0%, var(--color-accent-tertiary-bolder-900-default, #2A4A00) 0%, var(--color-accent-tertiary-bold-800-default, #3C6A00) 100%)",
                  iconVisible: false,
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    '<ol><li><a href="https://pubmed.ncbi.nlm.nih.gov/23469913/" target="_blank">Alonso et al., 2014; </a></li><li><a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10027780/pdf/11883_2023_Article_1091.pdf" target="_blank">Medeiros & Bourbon, 2023,</a></li></ol>',
                  textType: "bodyText",
                  textAlignment: "left",
                },
              ],
        ...
        // Introduction Screen 2
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'There is an <span style="color: var(--color-accent-secondary-bold-800-default);">80% chance</span> that <span style="color: var(--color-accent-secondary-bold-800-default);">your very high cholesterol is genetic.</span>',
              textType: "h2",
              textAlignment: "left",
            },

            {
              ...
              componentType: "text",
              textValue:
                "If your LDL cholesterol level is 190 mg/dl or higher, a genetic cause is highly likely.",
              textType: "bodyText",
              textAlignment: "left",
            },
          ],
        ...
        // Introduction Screen 3
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'FH, a genetic disease, is the <span style="color: var(--color-accent-primary-bold-800-default);">direct cause</span> of high cholesterol in <span style="color: var(--color-accent-primary-bold-800-default);">4 out of 5</span> affected people.',
              textType: "h2",
              textAlignment: "left",
            },
                  ...
                  pageSectionItems: [
                    {
                      ...
                      componentType: "text",
                      textValue:
                        "Tap the <b>Information</b> button on any page to see more details.",
                      textType: "caption",
                      textAlignment: "left",
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "FH is different from the kind of high cholesterol that comes from what you eat or how active you are. To know for sure if you have FH, you can get a special test called a genetic test. This test can tell if FH is the reason for your high cholesterol.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Knowing if you have FH can help your doctor choose the best treatment to lower your cholesterol and keep your heart healthy.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "You can sign up for testing today to see if FH is the cause of your high cholesterol.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  buttonStyle: "primary",
                  colorOverrideDefault:
                    "radial-gradient(40.23% 100% at 50.18% 0%, var(--color-accent-primary-700-default, #487D02) 0%, var(--color-primary-interact-bold-default, #3C6A00) 100%)",
                  colorOverrideHover:
                    "radial-gradient(40.41% 100% at 50.18% 0%, var(--color-accent-primary-600-default, #579605) 0%, var(--color-primary-interact-bold-default, #3C6A00) 100%)",
                  colorOverrideActive:
                    "radial-gradient(116.84% 49.82% at 50.18% 0%, var(--color-accent-primary-bolder-900-default, #2A4A00) 0%, var(--color-primary-interact-bold-default, #3C6A00) 100%)",
                  iconVisible: false,
                  iconFileName: "schedule-icon-fh.png",
                  iconHorizontalPlacement: "left",
                  textValue: "Schedule Appointment",
        ...
        // Introduction Screen 5
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                '<span style="color: var(--color-accent-warning-bold-800-default);">The right treatment</span> could <span style="color: var(--color-accent-warning-bold-800-default);">lower your risk</span> of heart disease greatly.',
              textType: "h2",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "FH is a condition that causes high cholesterol starting at birth. This can raise your chance of heart disease. But the good news is that getting tested and starting treatment early can really help.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Studies show that medicine like statins can lower your risk by a lot—up to 76%. After 10 years of treatment, your risk can be the same as someone without FH, and it can stay that way with continued care<sup>(1)</sup>.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "That’s why it’s so important to catch FH early. With the right treatment, you can keep your heart healthy for many years.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Don’t wait—sign up for genetic testing today to take the first step!",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  buttonStyle: "primary",
                  colorOverrideDefault:
                    "radial-gradient(40.23% 100% at 50.18% 0%, var(--color-accent-warning-700-default, #487D02) 0%, var(--color-accent-warning-bold-800-default, #3C6A00) 100%)",
                  colorOverrideHover:
                    "radial-gradient(40.41% 100% at 50.18% 0%, var(--color-accent-warning-600-default, #579605) 0%, var(--color-accent-warning-bold-800-default, #3C6A00) 100%)",
                  colorOverrideActive:
                    "radial-gradient(116.84% 49.82% at 50.18% 0%, var(--color-accent-warning-bolder-900-default, #2A4A00) 0%, var(--color-accent-warning-bold-800-default, #3C6A00) 100%)",
                  iconVisible: false,
                  iconFileName: "schedule-icon-fh.png",
                  textValue: "Schedule Appointment",
                  destination: "fh-openSchedulingSection-001",
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    '<ol><li><a href="https://pubmed.ncbi.nlm.nih.gov/23469913/" target="_blank">Alonso et al., 2014; </a></li></ol>',
                  textType: "bodyText",
                  textAlignment: "left",
                },
              ],
        ...
        // Introduction Screen 6
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'Take your <span style="color: var(--color-accent-secondary-bold-800-default);">health</span> into your <span style="color: var(--color-accent-secondary-bold-800-default);">own hands</span> with genetic testing for FH.',
              textType: "h2",
              textAlignment: "left",
            },

            {
              ...
              componentType: "text",
              textValue:
                "Continue on to learn more about how signing up for genetic testing can benefit you and your family, and how to schedule your consultation!",
              textType: "bodyText",
              textAlignment: "left",
            },
          ],
    ...
    // Home Chapter ----------------------------------------------------------------------------------------------
    {
      ...
      progressBarColorBackground:
        "var(--color-accent-success-lighter-200-default)",
      chapterBackgroundColor: "#F7F9FA",
        ...
        // Home Screen ----------------------------------------------------------------------------------------------
        {
          ...
          pageItems: [
...

            {
              ...
              buttonStyle: "primary",
              colorOverrideDefault:
                "radial-gradient(40.23% 100% at 50.18% 0%, var(--color-accent-secondary-700-default, #487D02) 0%, var(--color-secondary-interact-bold-default, #3C6A00) 100%)",
              colorOverrideHover:
                "radial-gradient(40.41% 100% at 50.18% 0%, var(--color-accent-secondary-600-default, #579605) 0%, var(--color-secondary-interact-bold-default, #3C6A00) 100%)",
              colorOverrideActive:
                "radial-gradient(116.84% 49.82% at 50.18% 0%, var(--color-accent-secondary-bolder-900-default, #2A4A00) 0%, var(--color-secondary-interact-bold-default, #3C6A00) 100%)",
              iconVisible: false,
              iconFileName: "schedule-icon-fh.png",
              textValue: "Schedule Appointment",
              newTab: true,
...

            {
              ...
              componentType: "text",
              textValue:
                "You may be at risk for familial hypercholesterolemia (FH), a genetic condition that puts you at higher risk for heart disease. The good news? Early detection leads to effective treatment.",
              textType: "bodyText",
              textAlignment: "left",
            },

            {
              ...
              componentType: "text",
              textValue:
                "Scheduling your consultation is quick and easy. If you’re ready, book your appointment now. Need more information first? Explore how FH testing can benefit you, your loved ones, and your peace of mind.",
...

            {
              ...
              pageSectionItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "How does FH affect you directly? What does it mean for your personal health?",
                  textType: "bodyText",
                  textAlignment: "left",
...

            {
              ...
              pageSectionItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "What does FH mean for your family and their well-being?",
                  textType: "bodyText",
                  textAlignment: "left",
                  colorText: "var(--color-on-primary-container)",
                },
...

                {
                  ...
                  buttonStyle: "primary",
                  colorOverrideDefault:
                    "radial-gradient(40.23% 100% at 50.18% 0%, var(--color-accent-primary-700-default, #007A95) 0%, var(--color-primary-interact-bold-default, #00677E) 100%)",
                  colorOverrideHover:
                    "radial-gradient(40.41% 100% at 50.18% 0%, var(--color-accent-primary-600-default, #0091B1) 0%, var(--color-primary-interact-bold-default, #00677E) 100%)",
                  colorOverrideActive:
                    "radial-gradient(116.84% 49.82% at 50.18% 0%, var(--color-accent-primary-bolder-900-default, #004858) 0%, var(--color-primary-interact-bold-default, #00677E) 100%)",
                  iconVisible: false,
                  textValue: "Explore",
...

            {
              ...
              pageSectionItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "How can FH testing and the treatment it unlocks benefit my future finances?",
                  textType: "bodyText",
                  textAlignment: "left",
...

                {
                  ...
                  buttonStyle: "primary",
                  colorOverrideDefault:
                    "radial-gradient(40.23% 100% at 50.18% 0%, var(--color-accent-warning-700-default, #9E6300) 0%, var(--color-warning-interact-bold-default, #855300) 100%)",
                  colorOverrideHover:
                    "radial-gradient(40.41% 100% at 50.18% 0%, var(--color-accent-warning-600-default, #BC7600) 0%, var(--color-warning-interact-bold-default, #855300) 100%)",
                  colorOverrideActive:
                    "radial-gradient(116.84% 49.82% at 50.18% 0%, var(--color-accent-warning-bolder-900-default, #5D3A00) 0%, var(--color-warning-interact-bold-default, #855300) 100%)",
                  iconVisible: false,
                  textValue: "Explore",
...

            {
              ...
              pageSectionItems: [
...

                {
                  ...
                  buttonStyle: "primary",
                  colorOverrideDefault:
                    "radial-gradient(40.23% 100% at 50.18% 0%, var(--color-accent-tertiary-700-default, #C2349C) 0%, var(--color-tertiary-interact-bold-default, #AF1685) 100%)",
                  colorOverrideHover:
                    "radial-gradient(40.41% 100% at 50.18% 0%, var(--color-accent-tertiary-600-default, #D651B3) 0%, var(--color-tertiary-interact-bold-default, #AF1685) 100%)",
                  colorOverrideActive:
                    "radial-gradient(116.84% 49.82% at 50.18% 0%, var(--color-accent-tertiary-bolder-900-default, #80005E) 0%, var(--color-tertiary-interact-bold-default, #AF1685) 100%)",
                  iconVisible: false,
                  textValue: "Explore",
...

            {
              ...
              componentType: "text",
              textValue:
                "Sign up for an appointment to discuss the benefits of FH Genetic Testing with your healthcare provider.",
              textType: "bodyText",
              textAlignment: "left",
            },
    ...
    // Education Chapter ----------------------------------------------------------------------------------------------
    {
      ...
      progressBarVisible: true,
      progressBarColor:
        "var(--color-accent-secondary-bold-800-default, #3C6A00)",
      progressBarColorBackground:
        "var(--color-accent-secondary-lighter-200-default, #C6F090)",
      chapterBackgroundColor: "var(--osfBrand-limegray-50, #F7FAF3)",

      // TOP RIGHT BUTTON STYLES -------
      topRightNavButtonDestination: "fh-openSchedulingSection-001",
      topRightNavButtonColor:
        "linear-gradient(180deg, var(--color-accent-secondary-700-default, #487D02) 0%, var(--color-accent-secondary-bold-800-default, #3C6A00) 100%)",
      topRightNavButtonColorHover:
        "linear-gradient(180deg, var(--color-accent-secondary-600-default, #579605) 0%, var(--color-accent-secondary-bold-800-default, #3C6A00) 100%)",
      topRightNavButtonColorActive:
        "linear-gradient(180deg, var(--color-accent-secondary-900-default, #2A4A00) 0%, var(--color-accent-secondary-bold-800-default, #3C6A00) 100%)",
        ...
        // Education Screen 1
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                '<span style="color: var(--color-accent-secondary-bold-800-default);">90%</span> of the 1.3 million Americans living with FH are <span style="color: var(--color-accent-secondary-bold-800-default);">not diagnosed.</span>',
              textType: "h2",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Schedule an appointment with our providers to discuss how FH testing could benefit your health.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  buttonStyle: "primary",
                  colorOverrideDefault:
                    "radial-gradient(40.23% 100% at 50.18% 0%, var(--color-accent-secondary-700-default, #487D02) 0%, var(--color-accent-secondary-bold-800-default, #3C6A00) 100%)",
                  colorOverrideHover:
                    "radial-gradient(40.41% 100% at 50.18% 0%, var(--color-accent-secondary-600-default, #579605) 0%, var(--color-accent-secondary-bold-800-default, #3C6A00) 100%)",
                  colorOverrideActive:
                    "radial-gradient(116.84% 49.82% at 50.18% 0%, var(--color-accent-secondary-bolder-900-default, #2A4A00) 0%, var(--color-accent-secondary-bold-800-default, #3C6A00) 100%)",
                  iconVisible: false,
                  iconFileName: "schedule-icon-fh.png",
                  textValue: "Schedule Appointment",
                  destination: "fh-openSchedulingSection-001",
        ...
        // Education Screen 2
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'Untreated FH results in <span style="color: var(--color-accent-secondary-bold-800-default);">22x higher risk</span> of heart disease.',
              textType: "h2",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Familial hypercholesterolemia (FH) greatly increases the risk of heart disease if not treated.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    " Although only 0.5% of people have FH, this small group represents 20% of heart attacks in men under 45. People with FH are 22 times more likely to have a heart attack before age 45 than people without FH<sup>(2, 3)</sup>.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "The high LDL (“bad”) cholesterol levels from birth make heart disease more likely. If not treated, half of men and one in three women with FH will have a heart attack by age 60<sup>(1)</sup>. Cholesterol buildup happens slowly, so signs of heart problems don’t show up until it’s too late<sup>(3)</sup>.",
                  textType: "bodyText",
                  textAlignment: "left",
                },
        ...
        // Education Screen 3
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'Testing can <span style="color: var(--color-accent-secondary-bold-800-default);">prevent</span> deadly cardiac events such as <span style="color: var(--color-accent-secondary-bold-800-default);">strokes</span> and <span style="color: var(--color-accent-secondary-bold-800-default);">heart attacks.</span>',
              textType: "h2",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Finding out if you have FH gives you the chance to get these life-saving treatments.",
                  textType: "bodyText",
                  textAlignment: "left",
                },
        ...
        // Education Screen 4
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                '<span style="color: var(--color-accent-secondary-bold-800-default);">Decrease your risk</span> of coronary heart disease by <span style="color: var(--color-accent-secondary-bold-800-default);">76%</span> by getting tested and treated for FH.',
              textType: "h2",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Before statins, people with untreated FH were much more likely to die young from heart disease. But with treatment, they can live much longer and healthier lives <sup>(1)</sup>.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Take control of your heart health. Schedule to discuss FH genetic testing today and reduce your risk of heart disease.",
                  textType: "bodyText",
                  textAlignment: "left",
                },
        ...
        // Education Screen 5
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'Cut your cholesterol in <span style="color: var(--color-accent-secondary-bold-800-default);">half in only six months</span> with effective treatment for FH.',
              textType: "h2",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Treatment not only lowers cholesterol but also reduces the risk of serious heart problems like heart attacks and strokes by 76% <sup>(2)</sup>. If one medicine doesn’t work, there are many other options to help.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Start working toward lower cholesterol and better heart health — schedule an appointment to discuss FH genetic testing today.",
                  textType: "bodyText",
                  textAlignment: "left",
                },
        ...
        // Education Screen 6
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'Access to more effective treatments can only be given with <span style="color: var(--color-accent-secondary-bold-800-default);">testing and diagnosis.</span>',
              textType: "h2",
              textAlignment: "left",
            },
    ...
    // Family Chapter ----------------------------------------------------------------------------------------------
    {
      ...
      progressBarColorBackground:
        "var(--color-accent-primary-lighter-200-default, #A3EEFF)",
        ...
        // Family Screen 1
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'Children under 18 who are treated for FH have a <span style="color: var(--color-accent-primary-bold-800-default);">96% lower risk</span> of heart attacks and other cardiac events.',
              textType: "h2",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Treating familial hypercholesterolemia (FH) early can save lives. Research shows that children treated before age 18 have a 96% lower chance of having serious heart problems before they turn 40 compared to those who are not treated<sup>(3)</sup>.",
                  textType: "bodyText",
                  textAlignment: "left",
                },
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Schedule an appointment to discuss FH genetic testing to protect your and your child’s heart health.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  buttonStyle: "primary",
                  colorOverrideDefault:
                    "radial-gradient(40.23% 100% at 50.18% 0%, var(--color-accent-primary-700-default, #487D02) 0%, var(--color-accent-primary-bold-800-default, #3C6A00) 100%)",
                  colorOverrideHover:
                    "radial-gradient(40.41% 100% at 50.18% 0%, var(--color-accent-primary-600-default, #579605) 0%, var(--color-accent-primary-bold-800-default, #3C6A00) 100%)",
                  colorOverrideActive:
                    "radial-gradient(116.84% 49.82% at 50.18% 0%, var(--color-accent-primary-bolder-900-default, #2A4A00) 0%, var(--color-accent-primary-bold-800-default, #3C6A00) 100%)",
                  iconVisible: false,
                  iconFileName: "schedule-icon-fh.png",
                  textValue: "Schedule Appointment",
                  destination: "fh-openSchedulingSection-001",
        ...
        // Family Screen 2
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                '<span style="color: var(--color-accent-primary-bold-800-default);">Less time</span> exposed to high cholesterol <span style="color: var(--color-accent-primary-bold-800-default);">decreases risk</span> of heart disease.',
              textType: "h2",
              textAlignment: "left",
            },

            {
              ...
              componentType: "text",
              textValue:
                "Getting your children or other family members tested at a younger age gives them a chance at a healthier life.",
              textType: "bodyText",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    '<ol><li><a href="https://www.nejm.org/doi/pdf/10.1056/NEJMoa1816454" target="_blank">Luirink et al., 2019; 20-Year Follow-up of Statins in Children with Familial Hypercholesterolemia</a></li></ol>',
                  textType: "bodyText",
                  textAlignment: "left",
                },
              ],
        ...
        // Family Screen 3
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'Children without symptoms usually don’t qualify without <span style="color: var(--color-accent-primary-bold-800-default);">family history.</span>',
              textType: "h2",
              textAlignment: "left",
            },

            {
              ...
              componentType: "text",
              textValue:
                "Getting tested yourself could open up proactive, personalized healthcare plans for your family.",
              textType: "bodyText",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "FH is often silent, which means it doesn’t show clear signs until serious heart problems happen. Many kids with FH don’t get signs like fatty bumps under the skin or around the eyes until their cholesterol has been too high for a long time<sup>(1)</sup>.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Because there are often no early signs, doctors may not test kids for FH unless someone in the family already has it. If there’s no family history, the condition can be missed until it’s too late.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Genetic testing helps find FH early. If you get tested, it can also help your family get tested and treated sooner.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Help protect your family’s health by scheduling to discuss FH testing.",
                  textType: "bodyText",
                  textAlignment: "left",
                },
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    '<ol><li><a href="https://www.ahajournals.org/doi/epub/10.1161/JAHA.119.013225" target="_blank">McGowan et al., 2019; Diagnosis and Treatment of Heterozygous Familial Hypercholesterolemia</a></li></ol>',
                  textType: "bodyText",
                  textAlignment: "left",
                },
              ],
        ...
        // Family Screen 4
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'If you test positive, tests for your children will have close to <span style="color: var(--color-accent-primary-bold-800-default);">100% accuracy.</span>',
              textType: "h2",
              textAlignment: "left",
            },
        ...
        // Family Screen 6
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'It’s <span style="color: var(--color-accent-primary-bold-800-default);">never too early</span> to be screened for FH.',
              textType: "h2",
              textAlignment: "left",
            },

            {
              ...
              componentType: "text",
              textValue:
                "Research recommends screening as early as two years of age for children with family history.",
              textType: "bodyText",
              textAlignment: "left",
            },
        ...
        // Family Screen 7
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'Get <span style="color: var(--color-accent-primary-bold-800-default);">tested and diagnosed</span> to ensure better care for you and your family.',
              textType: "h2",
              textAlignment: "left",
            },
          ],
    ...
    // Insurance Chapter ----------------------------------------------------------------------------------------------
    {
      ...
      progressBarVisible: true,
      progressBarColor:
        "var(--color-accent-tertiary-bold-800-default, #AF1685)",
      progressBarColorBackground:
        "var(--color-accent-tertiary-lighter-200-default, #FFD7F4)",
      chapterBackgroundColor: "var(--osfBrand-magentagray-50, #FFF7FD)",

      // TOP RIGHT BUTTON STYLES -------
      topRightNavButtonDestination: "fh-openSchedulingSection-001",
      topRightNavButtonColor:
        "linear-gradient(180deg, var(--color-accent-tertiary-700-default, #C2349C) 0%, var(--color-accent-tertiary-bold-800-default, #AF1685) 100%)",
      topRightNavButtonColorHover:
        "linear-gradient(180deg, var(--color-accent-tertiary-600-default, #D651B3) 0%, var(--color-accent-tertiary-bold-800-default, #AF1685) 100%)",
      topRightNavButtonColorActive:
        "linear-gradient(180deg, var(--color-accent-tertiary-900-default, #80005E) 0%, var(--color-accent-tertiary-bold-800-default, #AF1685) 100%)",
        ...
        // Insurance Screen 1
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'In Illinois, genetic data is <span style="color: var(--color-accent-tertiary-bold-800-default);">protected by HIPAA.</span>',
              textType: "h2",
              textAlignment: "left",
            },

            {
              ...
              componentType: "text",
              textValue:
                "Your genetic data cannot be used against you by your employer or your insurance.",
              textType: "bodyText",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "In Illinois, your genetic information is protected by strong privacy laws. A national law called HIPAA says your genetic data is private health information. This means doctors and insurance companies must keep it safe and cannot share it without your permission.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Illinois also has a special law called the Genetic Information Privacy Act (GIPA). This law says employers are not allowed to ask for or use your genetic information when making job decisions. If someone breaks this law, they can be fined up to $15,000<sup>(1, 2)</sup>.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "You can feel safe knowing your genetic information is private. Schedule to talk about FH genetic testing with us today, knowing your data is protected.",
                  textType: "bodyText",
                  textAlignment: "left",
                },
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    '<ol><li><a href="https://schneiderwallace.com" target="_blank">Schneider Wallace Cottrell Konecky LLP. 2024, The Illinois Genetic Information Privacy Act (GIPA)</a></li><li><a href="https://dandodiary.com" target="_blank">The D&O Diary, 2024, What you Need to Know about Illinois’ Genetic Information Privacy Act</a></li></ol>',
                  textType: "bodyText",
                  textAlignment: "left",
                },
              ],
        ...
        // Insurance Screen 2
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'Diagnosis and treatment can lead to <span style="color: var(--color-accent-tertiary-bold-800-default);">lower premiums.</span>',
              textType: "h2",
              textAlignment: "left",
            },

            {
              ...
              componentType: "text",
              textValue:
                "Decreasing your cholesterol through better treatment can decrease your insurance premium, saving you money.",
              textType: "bodyText",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Consider getting genetic testing for FH to help manage your cholesterol and get better life insurance options. Schedule an appointment today to discuss it with a provider!",
                  textType: "bodyText",
                  textAlignment: "left",
                },
        ...
        // Insurance Screen 3
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'Your health insurance <span style="color: var(--color-accent-tertiary-bold-800-default);">cannot drop you</span> based on your genetic data.',
              textType: "h2",
              textAlignment: "left",
            },

            {
              ...
              componentType: "text",
              textValue:
                "The Genetic Information Nondiscrimination Act (GINA) protects people from discrimination based on their genetics.",
              textType: "bodyText",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Feel secure in your genetic testing - schedule an appointment today, knowing your health insurance coverage is protected.",
                  textType: "bodyText",
                  textAlignment: "left",
                },
        ...
        // Insurance Screen 4
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                '<span style="color: var(--color-accent-tertiary-bold-800-default);">More protections</span> are added every year. Stay informed about genetic data privacy.',
              textType: "h2",
              textAlignment: "left",
            },
          ],
    ...
    // Cost Chapter ----------------------------------------------------------------------------------------------
    {
      ...
      progressBarColorBackground:
        "var(--color-accent-warning-lighter-200-default, #FFDEA6)",
      chapterBackgroundColor: "var(--osfBrand-orangegray-50, #FCF9F4)",

      // TOP RIGHT BUTTON STYLES -------
      topRightNavButtonDestination: "fh-openSchedulingSection-001",
      topRightNavButtonColor:
        "linear-gradient(180deg, var(--color-accent-warning-700-default, #9E6300) 0%, var(--color-accent-warning-bold-800-default, #855300) 100%)",
      topRightNavButtonColorHover:
        "linear-gradient(180deg, var(--color-accent-warning-600-default, #BC7600) 0%, var(--color-accent-warning-bold-800-default, #855300) 100%)",
      topRightNavButtonColorActive:
        "linear-gradient(180deg, var(--color-accent-warning-900-default, #5D3A00) 0%, var(--color-accent-warning-bold-800-default, #855300) 100%)",
        ...
        // Cost Screen 2
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'Getting tested and diagnosed for FH can <span style="color: var(--color-accent-warning-bold-800-default);">save you high medical expenses.</span> ',
              textType: "h2",
              textAlignment: "left",
            },

            {
              ...
              componentType: "text",
              textValue:
                "Find out how you could save on personal medical expenses by scheduling a discussion with our providers.",
              textType: "bodyText",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Identifying FH early may save you considerably in future health care costs. With the right diagnosis, you can start treatments to lower the chances of expensive health problems like heart attacks, strokes, or surgeries<sup>(1, 2)</sup>.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Studies show that getting genetic testing and starting treatment early helps people stay healthier and save money over time. Patients need fewer hospital visits, pay less for treatments, and help their family members stay healthy too<sup>(2)</sup>.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Start saving on future health care costs by scheduling an appointment to discuss FH genetic testing today.",
                  textType: "bodyText",
                  textAlignment: "left",
                },
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    '<ol><li><a href="https://acc.org" target="_blank">American College of Cardiology, 2024</a></li><li><a href="https://news.vumc.org" target="_blank">Vanderbilt University Medical Center, 2023</a></li></ol>',
                  textType: "bodyText",
                  textAlignment: "left",
                },
              ],
        ...
        // Cost Screen 3
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'Being tested can save your <span style="color: var(--color-accent-warning-bold-800-default);">whole family</span> on costly future care and treatment.',
              textType: "h2",
              textAlignment: "left",
            },
            ...
            // Learn More Modal
            {
              ...
              modalItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Many programs even offer free or cheaper tests for family members, making it easier to get the care needed<sup>(3)</sup>. Catching FH early with genetic testing is one of the best ways to prevent heart disease and save money.",
                  textType: "bodyText",
                  textAlignment: "left",
                },

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Protect your family’s health and finances by scheduling to discuss FH genetic testing today.",
                  textType: "bodyText",
                  textAlignment: "left",
                },
        ...
        // Cost Screen 4
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                'No insurance? Too expensive? <span style="color: var(--color-accent-warning-bold-800-default);">Talk to us!</span> ',
              textType: "h2",
              textAlignment: "left",
            },

            {
              ...
              componentType: "text",
              textValue:
                "Schedule with our providers to discuss options for financial aid, and how you can get the best treatment possible for your condition through FH testing.",
              textType: "bodyText",
              textAlignment: "left",
            },
        ...
        // Scheduling Screen 1
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                "The process of getting genetic testing for FH follows three steps:",
              textType: "bodyText",
              textAlignment: "left",
            },
...

            {
              ...
              pageSectionItems: [
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "Schedule Appointment with a provider to discuss a possible genetic component for your high LDL.",
                  textType: "bodyText",
                  textAlignment: "left",
                },
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "If your provider recommends testing, they will schedule you for a testing session.",
                  textType: "bodyText",
                  textAlignment: "left",
                },
...

                {
                  ...
                  componentType: "text",
                  textValue:
                    "After 7-10 days, you’ll have your results, and can pursue tailored treatment and counseling options.",
                  textType: "bodyText",
                  textAlignment: "left",
                },
              ],
...

            {
              ...
              componentType: "text",
              textValue:
                "<br>To start the first step, 'Consultation', you will need to schedule an appointment through our scheduling site. Press 'Continue' to learn how.",
              textType: "bodyText",
              textAlignment: "left",
            },
          ],
        ...
        // Scheduling Screen 2
        {
          ...
          pageItems: [
...

            {
              ...
              componentType: "text",
              textValue:
                "The button below will take you into our scheduling site. Please fill out all information and answer questions as instructed.",
              textType: "bodyText",
              textAlignment: "left",
            },
...

            {
              ...
              componentType: "text",
              textValue:
                "Near the end of the form, you will see the box displayed below:",
              textType: "bodyText",
              textAlignment: "left",
            },
...

            {
              ...
              componentType: "text",
              textValue:
                "When you see this box, please write '<b>FH Screening</b>.' This will let our providers know that you want to discuss signing up for testing.",
              textType: "bodyText",
              textAlignment: "left",
            },

            {
              ...
              componentType: "text",
              textValue:
                "Please go to the scheduling site to create your appointment!",
              textType: "bodyText",
              textAlignment: "left",
            },
          ],
            ...
            bottomButtonHolderItems: [
              {
                ...
                externalLink:
                  "https://www.osfmychart.org/OSFMyChart/openscheduling/SignupAndSchedule/EmbeddedSchedule?id=19012141,19004172,10000094,19009962,1533,10000143,10000108,10000060,10000186&vt=1004&dept=11102001,11161801,11100107,11162301&linksource=fh",
              },
            ],
          },
        },
