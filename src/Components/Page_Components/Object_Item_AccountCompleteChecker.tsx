...
export default function AccountCompleteChecker(props: AccountCompleteChecker_Props) {
    ...
    function RenderAccountCompleteChecker() {
        ...
        if (props.given_AccountComplete) {
            return (<>
                ...
                {Render_OptionalSection_AccountComplete()}
            ...
            return (<>
                ...
                {Render_OptionalSection_AccountIncomplete()}

            </>)
        }
        else {
            console.log("Logic error in Object_Item_RegisteredChecker.tsx, we shouldn't be seeing this else in RenderRegisterChecker function")
        }
    ...
    function Render_OptionalSection_AccountComplete() {
        return (<>
            ...
            <Object_Item_Text givenTextValue={props.given_AccountCompleteText}
            ...
            <Object_Button_Normal
                ...
                givenDestination={props.given_AccountCompleteDestination} //Jake fill this out
                ...
                givenTagToWrite={""}
                givenDataToWrite={""}
                givenCheckTagsToDetermineRendering={function (givenTagInclusion: string, givenTagExclusion: string, givenObjectName: string, givenObjectType: string, givenObjectExcludeByDefault: boolean): boolean {
                    return true;
                }}
                givenGlobal_isMobile={props.givenGlobal_isMobile}
                givenGlobal_CurrentCarouselIndex={0}
